...
export function EditEventForm({ event, onCancel }) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <h1 className="text-3xl text-foreground mb-6">Edit Event</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input id="edit-event-location" type="text" value={formData.location} onChange={(e) => setFormData({ ...formData, location: e.target.value })} placeholder={formData.event_type === 'virtual' ? 'Virtual Event' : 'e.g., San Francisco Convention Center'} className="w-full px-4 py-3 bg-input-background border border-input rounded-xl text-foreground focus:outline-none focus:ring-2 focus:ring-primary" required />
            </div>
            <div>
              <label htmlFor="edit-event-address" className="block text-sm mb-2 text-foreground">Full Address</label>
            ...
            <div className="md:col-span-2">
              <label htmlFor="edit-short-description" className="block text-sm mb-2 text-foreground">Short Description *</label>
              <textarea id="edit-short-description" value={formData.shortDescription} onChange={(e) => setFormData({ ...formData, shortDescription: e.target.value })} rows={3} placeholder="Brief overview shown in event cards" className="w-full px-4 py-3 bg-input-background border border-input rounded-xl text-foreground focus:outline-none focus:ring-2 focus:ring-primary resize-none" required />
            </div>
